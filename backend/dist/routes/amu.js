...
router.get('/amu/summary', (_req, res) => {
    const totalTreatments = dbService_1.db.treatments.length;
    const treatedAnimalsCount = new Set(dbService_1.db.treatments.map((t) => t.animal_id)).size;
