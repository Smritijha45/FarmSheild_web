      ...
      {loading ? (
        ...
        <div className="bg-[#1B5E20] text-white rounded-3xl p-8 shadow-2xl space-y-4">
          ...
          <p className="text-xs sm:text-sm text-[#E8F5E9] font-bold leading-relaxed">
            आपके किसी भी पशु पर इस समय दवाई का प्रभाव नहीं है। सभी पशुओं का दूध बेचना और एकत्र करना पूर्णतः सुरक्षित है।
          </p>
        </div>
      ) : (
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <h2 className="text-xl sm:text-2xl font-black text-[#D32F2F] mt-1">
                {activeMilkWithdrawals.length} पशु का दूध रोकने का समय चल रहा है
              </h2>
            </div>
          </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <span className="text-xs text-[#D32F2F] font-black">दवाई: {w.medicineName}</span>
                    </div>
                  </div>

                  <Badge variant="error" className="font-black">
                    {w.remainingDays} दिन बाकी
                  </Badge>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 text-xs bg-[#FFFDF5] p-4 rounded-xl border border-gray-200 font-bold">
                  <div>
                    ...
                    <span className="font-black text-[#1B5E20] text-sm">
                      {new Date(w.endDate).toLocaleDateString('hi-IN', { day: 'numeric', month: 'short', year: 'numeric' })}
                    </span>
                  </div>

                  <div>
                    <span className="text-gray-500 block">{t('withdrawal.medicineUsed')}</span>
                    <span className="font-black text-gray-900">{w.medicineName} ({w.withdrawalDays} दिन नियम)</span>
                  </div>
                </div>
              </div>
            ))}
